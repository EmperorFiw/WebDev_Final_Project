...
<div class="container mx-auto p-8 flex justify-center">
    <div class="bg-[#301580] p-6 rounded-lg w-full max-w-5xl flex"> 
        <div class="w-3/4 pr-4">
            <h2 class="text-3xl font-bold mb-6">สร้างกิจกรรม</h2> 
            <form method="POST">
                <div class="grid gap-6 mb-4 md:grid-cols-2">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="event_name" placeholder="จำนวนคนที่รับ" class="p-2 rounded-lg bg-[#D9D9D9] w-full text-black">
                    </div>
                    ...
                    <div class="">  
                        ...
                        <input type="date" name="reg_start_dat" placeholder="วันเปิดรับสมัคร" class="p-2 rounded-lg bg-[#D9D9D9] w-full text-black">
                    </div>

                    <div class="">
                        <label for="reg_end_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">วันปิดรับสมัคร</label>
                        <input type="date" name="reg_end_dat" placeholder="วันปิดรับสมัคร" class="p-2 rounded-lg bg-[#D9D9D9] w-full text-black">
                    </div>
                </div>
            ...
            <div class="mt-auto w-full">
                <button type="button" class="bg-[#0A7500] mt-3 p-2 rounded-lg w-1/3 text-white font-bold hover:bg-red-800 transition">ยืนยัน</button>
            </div>
        </div>
